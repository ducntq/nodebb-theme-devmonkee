...
Theme.registerPage = async (params) => {
    ...
    routeHelpers.setupPageRoute(router, '/devmonkee', middleware, [middleware.buildHeader], async (req, res) => {
        ...
        return await res.render('homepage', {title: 'DEVVVVVVVVVV', topics: topics});
	});
};
